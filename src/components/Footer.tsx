export default function Footer(){
    return(
        <div className="footer flex-col md:flex-row flex items-center px-[100px] gap-8 bg-[#252b46] py-[30px] max-w-[1440px] mx-auto justify-between ">
            ...
            <img src="/src/assets/logo-bookmark-footer.svg" alt="logo" />
            ...
            <div className="social-media ">
                <ul className="flex justify-center items-center gap-4">
                    <li><a className="hover:text-red-400" href="#facebook"><img src="/src/assets/icon-facebook.svg" alt="" /></a></li>
                    <li><a className="hover:text-red-400" href="#twitter"><img src="/src/assets/icon-twitter.svg" alt="" /></a></li>
                </ul>
            </div>
